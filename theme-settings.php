 ...
 */
function soe_basic_form_system_theme_settings_alter(array &$form, FormStateInterface $form_state) {
  ...
  $form['options_settings']['show_su_med_logo'] = [
    '#type' => 'checkbox',
    '#title' => t('Show Stanford Medicine Logo'),
    '#default_value' => theme_get_setting('show_su_med_logo'),
  ];
